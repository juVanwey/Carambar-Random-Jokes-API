...
// On utilise Swagger pour servir la documentation accessible sous /api-docs. Quand on navigue vers 'localhost:5007/api-docs', Swagger affichera l'interface de la documentation de l'API
